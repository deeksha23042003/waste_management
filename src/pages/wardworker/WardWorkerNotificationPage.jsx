...
import './WardWorkerNotificationPage.css';

const WardWorkerNotificationPage = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            // Fetch notifications for the current ward worker
    ...
    if (loading) {
        return (
            <div className="worker-notification-page">
                <WardWorkerHeader />
                <main className="worker-notification-main">
    ...
    return (
        <div className="worker-notification-page">
            ...
            <main className="worker-notification-main">
                <div className="worker-notification-header">
                    <div className="header-text">
                        <h1>Work Notifications</h1>
                        <p>Stay updated on assigned complaints and task updates.</p>
                    </div>
                ...
                <div className="notifications-list">
                    {filteredNotifications.length === 0 ? (
                        <div className="empty-state">
                            ...
                            <p>Task assignments and updates will appear here</p>
                        </div>
                    ) : (
                                            ...
                                            <div className="notification-details">
                                                <div className="meta-info">
                                                    <span className="complaint-id">
                                                        Task #{notification.complaint_id}
                                                    </span>
                                                ...
                                                <h3 className="notification-title">
                                                    {complaint?.description || 'Task Update'}
                                                </h3>
...
export default WardWorkerNotificationPage;